    ...
    for z = 1:floor((length(signal)-window_size)/step)
        ...
        if amplitude_window < threshold
            ...
            if start_note == 0
                ...
                elseif amplitude_window > freq_times(3,z-1) + 0.005 || freq >= 1.0293 * previous_freq || freq <= (1/1.0293) * previous_freq
                    if_note = 1;
                    start_note = z;
                elseif amplitude_window > freq_times(3,z-2) + 0.005 || freq >= 1.0293 * previous_freq || freq <= (1/1.0293) * previous_freq
                    if_note = 1;
                    start_note = z;
                else
                    if_note = 0;
